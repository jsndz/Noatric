...
import { fetchAllBrandsAsync, selectAllBrands } from "../Product/brandSlice";
import {
...
import { getUserInfoAsync, selectUserInfo } from "../auth/authSlice";
...
export default function AdminProductList() {
  ...
  return showEditForm === true ? (
    <CreateProductForm setShowEditForm={setShowEditForm}></CreateProductForm>
  ) : (
            ...
            <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
              <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                {products.map((product) => (
                  <Link to={`/admin/details/${product.id}`} key={product.id}>
